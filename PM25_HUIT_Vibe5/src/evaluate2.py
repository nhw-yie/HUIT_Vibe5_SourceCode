...
def main():
    ...
    # Load dataset trạm mới
    df = pd.read_csv(data_dir / "dataset_features_2.csv", parse_dates=['ts_utc'])
    ...
    # Lưu kết quả
    out_file = out_dir / "Traffic_PM25_predictions.csv"
    df[['ts_utc','latitude','longitude','PM25_pred']].to_csv(out_file, index=False)
